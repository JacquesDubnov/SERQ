...
must_haves:
  ...
  notes:
    - "autonomous:false because this plan requires human verification at end (Task 3)"
    - "The checkpoint:human-verify task is how the plan-level autonomous:false manifests"
    - "Executor should NOT proceed past Task 3 without user approval"
---
...
**Version History (VER-01 to VER-05)**
...
7. Click a version - preview should show read-only content (not diff view)
8. Click "Restore This Version" - should restore with backup checkpoint
9. Verify: Current content replaced with version content
Note: VER-06 (section restore) is DEFERRED - copy/paste from preview is the v1 workaround
...
**UI Polish (UI-02, UI-03, UI-05)**
29. Press Cmd+Shift+F to enter focus mode (UI-02)
...
33. Look at status bar - verify word count, char count, Ln/Col (accuracy check)
34. Type some text - counts should update correctly
35. Click "Typewriter" toggle (UI-03) - cursor should stay centered while typing
36. For distraction-free writing (UI-05): Enable both focus mode + typewriter mode together

**Final Checks**
37. Verify app doesn't crash during normal use
38. Check console for any errors
39. Test dark mode - all panels should respect theme
  </how-to-verify>
