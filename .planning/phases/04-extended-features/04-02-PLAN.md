...
<task type="auto">
  ...
  <verify>
    1. Open command palette, see shortcuts next to each command
    2. Close with Escape, cursor returns to editor position
    3. Type "/h2" in editor, dropdown appears with Heading 2 option (confirms SlashCommands extension from Task 2 is registered)
  </verify>
  <done>
    Command palette shows keyboard shortcut hints, focus management works correctly, slash commands confirmed working.
  </done>
</task>
